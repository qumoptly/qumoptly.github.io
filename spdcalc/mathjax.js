...
function(t, e) {
    ...
    MathJax.version = "2.7.0-beta", MathJax.fileversion = "2.7.0-beta", MathJax.cdnVersion = "2.7.0-beta", MathJax.cdnFileVersions = {},
    function(t) {
        var e = window[t];
        e || (e = window[t] = {});
        var i = [],
        n = function(t) {
            var e = t.constructor;
            e || (e = function() {});
            for (var i in t)"constructor" !== i && t.hasOwnProperty(i) && (e[i] = t[i]);
            return e
        },
        a = function() {
            return function() {
                ...
                wrap: function(t, e) {
                    ...
                    var i = function() {
                        ...
                        try {
                            ...
                            throw delete this.SUPER,
                            a
                        }
                        return delete this.SUPER,
                        n
                    };
        ...
        e.Object.isArray = Array.isArray ||
        function(t) {
    ...
    function(t) {
        ...
        n = function(t) {
            ...
            for (var i in n.prototype) n.prototype.hasOwnProperty(i) && ("undefined" != typeof t[i] ? e[i] = t[i] : e[i] = n.prototype[i]);
            return e.toString = n.prototype.toString,
            e
        };
        n.prototype = {
            isCallback: !0,
            ...
            object: window,
            execute: function() {
                if (!this.called || this.autoReset) return this.called = !this.autoReset,
        ...
        r = function() {
            ...
            } else s = window.execScript ?
            function(i) {
                e.__code = i,
                i = "try {" + t + ".__result = eval(" + t + ".__code)} catch(err) {" + t + ".__result = err}",
                window.execScript(i);
                var n = e.__result;
                if (delete e.__result, delete e.__code, n instanceof Error) throw n;
                return n
            }: function(i) {
                e.__code = i,
                i = "try {" + t + ".__result = eval(" + t + ".__code)} catch(err) {" + t + ".__result = err}";
                ...
                n.removeChild(a);
                var s = e.__result;
                if (delete e.__result, delete e.__code, s instanceof Error) throw s;
                return s
            };
            r = null
        },
        o = function(t, e) {
            if (arguments.length > 1 && (t = 2 === arguments.length && "function" != typeof arguments[0] && arguments[0] instanceof Object && "number" == typeof arguments[1] ? [].slice.call(t, e) : [].slice.call(arguments, 0)), i(t) && 1 === t.length && (t = t[0]), "function" == typeof t) return t.execute === n.prototype.execute ? t: n({
                hook: t
            });
            if (i(t)) {
                ...
                if ("function" == typeof t[0]) return n({
                    hook: t[0],
                    data: t.slice(1)
                });
                if ("function" == typeof t[1]) return n({
                    hook: t[1],
                    object: t[0],
                    data: t.slice(2)
                })
            } else {
                if ("string" == typeof t) return r && r(),
                n({
                    hook: s,
                    data: [t]
                });
        ...
        l = function(t, e) {
            return e = o(e),
            e.timeout = setTimeout(e, t),
            e
        },
        h = function(t, e) {
            t = o(t),
            t.called || (c(t, e), e.pending++)
        },
        u = function() {
            var t = this.signal;
            delete this.signal,
            ...
            if (a(e) && !e.called) c(e, t);
            else for (var i = 0,
            n = t.length; i < n; i++) t[i].pending--,
            t[i].pending <= 0 && t[i].call()
        },
        c = function(t, e) {
            i(e) || (e = [e]),
            t.signal ? 1 === e.length ? t.signal.push(e[0]) : t.signal = t.signal.concat(e) : (t.oldExecute = t.execute, t.execute = u, t.signal = e)
        },
        p = function(t) {
            t = o(t),
            t.pending = 0;
            for (var e = 1,
            i = arguments.length; e < i; e++) arguments[e] && h(arguments[e], t);
            if (0 === t.pending) {
                var n = t();
                a(n) && (t = n)
            }
        ...
        d = MathJax.Object.Subclass({
            ...
            Add: function(t, e) {
                ...
                return this.hooks.splice(i, 0, t),
                t
            },
            Remove: function(t) {
                for (var e = 0,
                i = this.hooks.length; e < i; e++) if (this.hooks[e] === t) return void(this.running ? this.remove.push(e) : this.hooks.splice(e, 1))
            },
            Execute: function() {
                var t = [{}];
                this.running = !0;
                for (var e = 0,
                i = this.hooks.length; e < i; e++) {
                ...
                1 === t.length ? null: 2 === t.length ? t[1] : p.apply({},
                t)
            },
        ...
        f = function(t, e, n) {
            ...
            i(t) || (t = [t]),
            i(e) || (e = null == e ? [] : [e]);
            for (var a = d(n), s = 0, r = t.length; s < r; s++) a.Add(t[s]);
        ...
        g = e.Object.Subclass({
            ...
            Push: function() {
                for (var t, e = 0,
                i = arguments.length; e < i; e++) t = o(arguments[e]),
                t !== arguments[e] || t.called || (t = o(["wait", this, t])),
                this.queue.push(t);
                return this.running || this.pending || this.Process(),
                t
            },
            Process: function(t) {
        ...
        x = g.Subclass({
            ...
            Post: function(t, e, i) {
                if (e = o(e), this.posting || this.pending) this.Push(["Post", this, t, e, i]);
                else {
                    this.callback = e,
                    e.reset(),
            ...
            Clear: function(t) {
                return t = o(t),
                this.posting || this.pending ? t = this.Push(["Clear", this, t]) : (this.posted = [], t()),
                t
            },
            call: function() {
                this.callback(this),
            ...
            Interest: function(t, e, i) {
                if (t = o(t), this.listeners.Add(t, i), !e) for (var n = 0,
                s = this.posted.length; n < s; n++) {
                    t.reset();
            ...
            MessageHook: function(t, e, i) {
                ...
                for (var n = 0,
                a = this.posted.length; n < a; n++) this.posted[n] == t && (e.reset(), e(this.posted[n]));
                return e.msg = t,
                e
            },
        ...
        },
        {
            signals: {},
            find: function(t) {
                return x.signals[t] || (x.signals[t] = new x(t)),
                x.signals[t]
            }
        });
        ...
        e.Callback.After = p,
        e.Callback.Queue = g,
        e.Callback.Signal = x.find,
        e.Callback.Hooks = d,
        e.Callback.ExecuteHooks = f
    } ("MathJax"),
    function(t) {
        var e = window[t];
        e || (e = window[t] = {});
        var i = "Apple Computer, Inc." === navigator.vendor && "undefined" == typeof navigator.vendorSub,
        n = 0,
        a = function(t) {
            return document.styleSheets && document.styleSheets.length > n && (n = document.styleSheets.length),
            t || (t = document.head || document.getElementsByTagName("head")[0], t || (t = document.body)),
            t
        },
        s = [],
        r = function() {
            for (var t = 0,
            i = s.length; t < i; t++) e.Ajax.head.removeChild(s[t]);
            s = []
        },
        o = {};
        o[t] = "",
        o.Contrib = "https://cdn.mathjax.org/mathjax/contrib",
        e.Ajax = {
            loaded: {},
            loading: {},
            loadHooks: {},
            ...
            fileURL: function(t) {
                ...
                return e && e[1] in o && (t = (o[e[1]] || this.config.root) + t.substr(e[1].length + 2)),
                t
            },
            fileName: function(e) {
                var i = this.config.root;
                if (e.substr(0, i.length) === i) e = "[" + t + "]" + e.substr(i.length);
                else for (var n in o) if (o.hasOwnProperty(n) && o[n] && e.substr(0, o[n].length) === o[n]) {
                    e = "[" + n + "]" + e.substr(o[n].length);
                    break
                }
                return e
            },
            ...
            Require: function(t, i) {
                i = e.Callback(i);
                var n;
                if (t instanceof Object) for (var a in t) t.hasOwnProperty(a) && (n = a.toUpperCase(), t = t[a]);
                else n = t.split(/\./).pop().toUpperCase();
                if (this.params.noContrib && "[Contrib]" === t.substr(0, 9)) i(this.STATUS.ERROR);
            ...
            Load: function(t, i) {
                i = e.Callback(i);
                var n;
                if (t instanceof Object) for (var s in t) t.hasOwnProperty(s) && (n = s.toUpperCase(), t = t[s]);
                else n = t.split(/\./).pop().toUpperCase();
            ...
            timer: {
                create: function(t, a) {
                    ...
                    "STYLE" === a.nodeName && a.styleSheet && "undefined" != typeof a.styleSheet.cssText ? t(this.STATUS.OK) : window.chrome && "LINK" === a.nodeName ? t(this.STATUS.OK) : i ? this.timer.start(this, [this.timer.checkSafari2, n++, t], this.styleDelay) : this.timer.start(this, [this.timer.checkLength, a, t], this.styleDelay),
                    t
                },
                ...
                checkLength: function(t, i, n) {
                    if (!t.time(n)) {
                        ...
                        try { (s.cssRules || s.rules || []).length > 0 && (a = 1)
                        } catch(r) {
                            r.message.match(/protected variable|restricted URI/) ? a = 1 : r.message.match(/Security error/) && (a = 1)
                        }
            ...
            loadComplete: function(t) {
                ...
                return i && !i.preloaded ? (e.Message.Clear(i.message), clearTimeout(i.timeout), i.script && (0 === s.length && setTimeout(r, 0), s.push(i.script)), this.loaded[t] = i.status, delete this.loading[t], this.addHook(t, i.callback)) : (i && delete this.loading[t], this.loaded[t] = this.STATUS.OK, i = {
                    status: this.STATUS.OK
                }),
            ...
            Styles: function(t, i) {
                ...
                if ("" === n)(i = e.Callback(i))();
                    ...
                    s.styleSheet && "undefined" != typeof s.styleSheet.cssText ? s.styleSheet.cssText = n: s.appendChild(document.createTextNode(n)),
            ...
            StyleString: function(t) {
                ...
                else if (e.Object.isArray(t[i])) for (var s = 0; s < t[i].length; s++) n = {},
                n[i] = t[i][s],
                a += this.StyleString(n);
                else if ("@media" === i.substr(0, 6)) a += i + " {" + this.StyleString(t[i]) + "}\n";
                else if (null != t[i]) {
                    n = [];
                    for (var r in t[i]) t[i].hasOwnProperty(r) && null != t[i][r] && (n[n.length] = r + ": " + t[i][r]);
                    a += i + " {" + n.join("; ") + "}\n"
                }
                return a
            }
        ...
        Element: function(t, e, i) {
            ...
            if (e) {
                if (e.hasOwnProperty("style")) {
                    var s = e.style;
                    e.style = {};
                    for (n in s) s.hasOwnProperty(n) && (e.style[n.replace(/-([a-z])/g, this.ucMatch)] = s[n])
                }
                MathJax.Hub.Insert(a, e);
                for (n in e)"role" !== n && "aria-" !== n.substr(0, 5) || a.setAttribute(n, e[n])
            }
            if (i) {
                MathJax.Object.isArray(i) || (i = [i]);
                for (var r = 0,
                o = i.length; r < o; r++) MathJax.Object.isArray(i[r]) ? a.appendChild(this.Element(i[r][0], i[r][1], i[r][2])) : "script" === t ? this.setScript(a, i[r]) : a.appendChild(document.createTextNode(i[r]))
            }
            return a
        },
        ...
        getScript: function(t) {
            var e = "" === t.text ? t.innerHTML: t.text;
        ...
        Cookie: {
            ...
            Get: function(t, e) {
                ...
                if (i && "" !== i[1]) for (var s = unescape(i[1]).split("&;"), r = 0, o = s.length; r < o; r++) {
                    i = s[r].match(/([^:]+):(.*)/);
                    var l = i[2].replace(/&&/g, "&");
                    "true" === l ? l = !0 : "false" === l ? l = !1 : l.match(/^-?(\d+(\.\d+)?|\.\d+)$/) && (l = parseFloat(l)),
                    e[i[1]] = l
                }
                return e
            }
    ...
    MathJax.Localization = {
        locale: "en",
        directory: "[MathJax]/spdcalc/localization",
        strings: {
            ast: {
                menuTitle: "asturianu"
            },
        ...
        SPLIT: 3 === "axb".split(/(x)/).length ?
        function(t, e) {
            return t.split(e)
        }: function(t, e) {
            var i, n = [],
            a = 0;
            for (e.lastIndex = 0; i = e.exec(t);) n.push(t.substr(a, i.index - a)),
            n.push.apply(n, i.slice(1)),
            a = i.index + i[0].length;
            return n.push(t.substr(a)),
            n
        },
        _: function(t, e) {
        ...
        processString: function(t, e, i) {
            ...
            for (n = 1, a = r.length; n < a; n += 2) {
                var o = r[n].charAt(0);
                if (o >= "0" && o <= "9") r[n] = e[r[n] - 1],
                "number" == typeof r[n] && (r[n] = this.number(r[n]));
                else if ("{" === o) if (o = r[n].substr(1), o >= "0" && o <= "9") r[n] = e[r[n].substr(1, r[n].length - 2) - 1],
                "number" == typeof r[n] && (r[n] = this.number(r[n]));
                else {
                    var l = r[n].match(/^\{([a-z]+):%(\d+)\|(.*)\}$/);
                    if (l) if ("plural" === l[1]) {
                        var h = e[l[2] - 1];
                        if ("undefined" == typeof h) r[n] = "???";
                        else {
                            h = this.plural(h) - 1;
                            var u = l[3].replace(/(^|[^%])(%%)*%\|/g, "$1$2%").split(/\|/);
                            h >= 0 && h < u.length ? r[n] = this.processString(u[h].replace(/\uEFEF/g, "|"), e, i) : r[n] = "???"
                        }
                    } else r[n] = "%" + r[n]
                }
                null == r[n] && (r[n] = "???")
            ...
            for (n = 0; n < a; n++) p += r[n],
            n++,
            n < a && (s(r[n]) ? (c.push(p), c = c.concat(r[n]), p = "") : p += r[n]);
            return "" !== p && c.push(p),
            c
        },
        ...
        processMarkdown: function(t, e, i) {
            for (var n, a = [], s = t.split(this.markdownPattern), r = s[0], o = 1, l = s.length; o < l; o += 8) s[o + 1] ? (n = this.processString(s[o + 2], e, i), MathJax.Object.isArray(n) || (n = [n]), n = [["b", "i", "i"][s[o + 1].length - 1], {},
            n], 3 === s[o + 1].length && (n = ["b", {},
            n])) : s[o + 3] ? (n = this.processString(s[o + 4].replace(/^\s/, "").replace(/\s$/, ""), e, i), MathJax.Object.isArray(n) || (n = [n]), n = ["code", {},
            n]) : s[o + 5] ? (n = this.processString(s[o + 5], e, i), MathJax.Object.isArray(n) || (n = [n]), n = ["a", {
                href: this.processString(s[o + 6], e),
                target: "_blank"
            },
            n]) : (r += s[o], n = null),
            n && (a = this.concatString(a, r, e, i), a.push(n), r = ""),
            "" !== s[o + 7] && (r += s[o + 7]);
            return a = this.concatString(a, r, e, i)
        },
        concatString: function(t, e, i, n) {
            return "" != e && (e = this.processString(e, i, n), MathJax.Object.isArray(e) || (e = [e]), t = t.concat(e)),
            t
        },
        ...
        loadFile: function(t, e, i) {
            if (i = MathJax.Callback(i), t = e.file || t, t.match(/\.js$/) || (t += ".js"), !t.match(/^([a-z]+:|\[MathJax\])/)) {
                var n = this.strings[this.locale].directory || this.directory + "/" + this.locale || "[MathJax]/spdcalc/localization/" + this.locale;
                t = n + "/" + t
            }
            var a = MathJax.Ajax.Require(t,
            function() {
                return e.isLoaded = !0,
                i()
            });
            return a.called ? null: a
        },
        ...
        setLocale: function(t) {
            this.resetLocale(t),
            MathJax.Menu && this.loadDomain("MathMenu")
        },
        ...
        setCSS: function(t) {
            ...
            return e && (e.fontFamily && (t.style.fontFamily = e.fontFamily), e.fontDirection && (t.style.direction = e.fontDirection, "rtl" === e.fontDirection && (t.style.textAlign = "right"))),
            t
        },
        fontFamily: function() {
    ...
    MathJax.Message = {
        ...
        browsers: {
            MSIE: function(t) {
                ...
                MathJax.Message.msieFixedPositionBug && (MathJax.Hub.config.styles["#MathJax_Message"].position = "absolute"),
        ...
        Init: function(t) {
            ...
            if (this.div && null == this.div.parentNode && (this.div = document.getElementById("MathJax_Message"), this.div && (this.text = this.div.firstChild)), !this.div) {
                var e = document.body;
                this.msieFixedPositionBug && window.attachEvent && (e = this.frame = this.addDiv(document.body), e.removeAttribute("id"), e.style.position = "absolute", e.style.border = e.style.margin = e.style.padding = "0px", e.style.zIndex = "101", e.style.height = "0px", e = this.addDiv(e), e.id = "MathJax_MSIE_Frame", window.attachEvent("onscroll", this.MoveFrame), window.attachEvent("onresize", this.MoveFrame), this.MoveFrame()),
        ...
        addDiv: function(t) {
            ...
            return e.id = "MathJax_Message",
            t.firstChild ? t.insertBefore(e, t.firstChild) : t.appendChild(e),
            e
        },
        MoveFrame: function() {
            var t = MathJax.Message.quirks ? document.body: document.documentElement,
        ...
        filterText: function(t, e, i) {
            return "simple" === MathJax.Hub.config.messageStyle && ("LoadFile" === i ? (this.loading || (this.loading = this.localize("Loading") + " "), t = this.loading, this.loading += ".") : "ProcessMath" === i ? (this.processing || (this.processing = this.localize("Processing") + " "), t = this.processing, this.processing += ".") : "TypesetMath" === i && (this.typesetting || (this.typesetting = this.localize("Typesetting") + " "), t = this.typesetting, this.typesetting += ".")),
            t
        },
        ...
        Set: function(t, e, i) {
            ...
            if (MathJax.Object.isArray(t)) {
                n = t[0],
                MathJax.Object.isArray(n) && (n = n[1]);
                try {
                    ...
                    MathJax.Callback.After(["Set", this, t, e, i], a.restart),
                    e
                }
            }
            return this.timer && (clearTimeout(this.timer), delete this.timer),
            this.log[e].text = t,
            this.log[e].filteredText = t = this.filterText(t, e, n),
            "undefined" == typeof this.log[e].next && (this.log[e].next = this.current, null != this.current && (this.log[this.current].prev = e), this.current = e),
            this.current === e && "none" !== MathJax.Hub.config.messageStyle && (this.Init() ? (this.textNodeBug ? this.div.innerHTML = t: this.text.nodeValue = t, this.div.style.display = "", this.status && (window.status = "", delete this.status)) : (window.status = t, this.status = !0)),
            this.log[e].restarted && (this.log[e].cleared && (i = 0), 0 === --this.log[e].restarted && delete this.log[e].cleared),
            i ? setTimeout(MathJax.Callback(["Clear", this, e]), i) : 0 == i && this.Clear(e, 0),
            e
        },
        Clear: function(t, e) {
            null != this.log[t].prev && (this.log[this.log[t].prev].next = this.log[t].next),
            null != this.log[t].next && (this.log[this.log[t].next].prev = this.log[t].prev),
            this.current === t && (this.current = this.log[t].next, this.text ? (null == this.div.parentNode && this.Init(), null == this.current ? (this.timer && (clearTimeout(this.timer), delete this.timer), null == e && (e = 600), 0 === e ? this.Remove() : this.timer = setTimeout(MathJax.Callback(["Remove", this]), e)) : "none" !== MathJax.Hub.config.messageStyle && (this.textNodeBug ? this.div.innerHTML = this.log[this.current].filteredText: this.text.nodeValue = this.log[this.current].filteredText), this.status && (window.status = "", delete this.status)) : this.status && (window.status = null == this.current ? "": this.log[this.current].text)),
    ...
    MathJax.Hub = {
        ...
        CombineConfig: function(t, e) {
            ...
            t = t.split(/\./);
            for (var s = 0,
            r = t.length; s < r; s++) i = t[s],
            a[i] || (a[i] = {}),
            n = a,
            a = a[i];
            return n[i] = a = this.Insert(e, a),
            a
        },
        Register: {
        ...
        setRenderer: function(t, e) {
            if (t) {
                if (MathJax.OutputJax[t]) {
                    this.config.menuSettings.renderer = t,
                    null == e && (e = "jax/mml");
                    var i = this.outputJax;
                    return i[e] && i[e].length && t !== i[e][0].id ? (i[e].unshift(MathJax.OutputJax[t]), this.signal.Post(["Renderer Selected", t])) : null
                }
                this.config.menuSettings.renderer = "";
                var n = "[MathJax]/spdcalc/jax/output/" + t + "/config.js";
                return MathJax.Ajax.Require(n, ["setRenderer", this, t, e])
            }
        },
        Queue: function() {
        ...
        PreProcess: function(t, e) {
            ...
            if (i.count) {
                ...
                for (var s = 0,
                r = a.length; s < r; s++) a[s] && n.Push(["Execute", this.preProcessors, a[s]]);
        ...
        takeAction: function(t, e, i) {
            ...
            if (n.count) {
                ...
                o[2] || (o = {}),
                s.Push(["clearCounts", MathJax.Message], ["Post", this.signal, ["Begin " + t, a]], ["Post", this.signal, ["Begin Math", a, t]], ["prepareScripts", this, t, a, r], ["Post", this.signal, ["Begin Math Input", a, t]], ["processInput", this, r], ["Post", this.signal, ["End Math Input", a, t]], o, ["prepareOutput", this, r, "preProcess"], o, ["Post", this.signal, ["Begin Math Output", a, t]], ["processOutput", this, r], ["Post", this.signal, ["End Math Output", a, t]], o, ["prepareOutput", this, r, "postProcess"], o, ["Post", this.signal, ["End Math", a, t]], ["Post", this.signal, ["End " + t, a]], ["clearCounts", MathJax.Message])
            }
        ...
        prepareScripts: function(t, e, i) {
            if (!arguments.callee.disabled) for (var n = this.elementScripts(e), a = MathJax.ElementJax.STATE, s = 0, r = n.length; s < r; s++) {
                var o = n[s];
                o.type && this.inputJax[o.type.replace(/ *;(.|\n)*/, "")] && (o.MathJax && (o.MathJax.elementJax && o.MathJax.elementJax.hover && MathJax.Extension.MathEvents.Hover.ClearHover(o.MathJax.elementJax), o.MathJax.state !== a.PENDING && this.scriptAction[t](o)), o.MathJax || (o.MathJax = {
                    state: a.PENDING
                }), o.MathJax.error && delete o.MathJax.error, o.MathJax.state !== a.PROCESSED && i.scripts.push(o))
            }
        },
        checkScriptSiblings: function(t) {
            if (!t.MathJax.checked) {
                ...
                if (i && "#text" === i.nodeName) {
                    ...
                    e.preJax && ("string" == typeof e.preJax && (e.preJax = new RegExp(e.preJax + "$")), n = i.nodeValue.match(e.preJax)),
                    e.postJax && s && ("string" == typeof e.postJax && (e.postJax = new RegExp("^" + e.postJax)), a = s.nodeValue.match(e.postJax)),
                    !n || e.postJax && !a || (i.nodeValue = i.nodeValue.replace(e.preJax, n.length > 1 ? n[1] : ""), i = null),
                    !a || e.preJax && !n || (s.nodeValue = s.nodeValue.replace(e.postJax, a.length > 1 ? a[1] : "")),
                    i && !i.nodeValue.match(/\S/) && (i = i.previousSibling)
                }
                e.preRemoveClass && i && i.className === e.preRemoveClass && (t.MathJax.preview = i),
                t.MathJax.checked = 1
            }
        },
        processInput: function(t) {
            var e, i, n, a = MathJax.ElementJax.STATE,
            s = t.scripts.length;
            try {
                for (; t.i < s;) if (i = t.scripts[t.i]) if (n = i.previousSibling, n && "MathJax_Error" === n.className && n.parentNode.removeChild(n), i.parentNode && i.MathJax && i.MathJax.state !== a.PROCESSED) {
                    if (i.MathJax.elementJax && i.MathJax.state !== a.UPDATE) i.MathJax.state === a.OUTPUT && this.saveScript(i.MathJax.elementJax, t, i, a);
                    else {
                        this.checkScriptSiblings(i);
                        var r = i.type.replace(/ *;(.|\s)*/, ""),
                        o = this.inputJax[r];
                        if (e = o.Process(i, t), "function" == typeof e) {
                    ...
                    l - t.start > this.processUpdateTime && t.i < t.scripts.length && (t.start = l, this.RestartAfter(MathJax.Callback.Delay(1)))
                } else t.i++;
                else t.i++
            } catch(h) {
                return this.processError(h, t, "Input")
            }
            return t.scripts.length && this.config.showProcessingMessages && MathJax.Message.Set(["ProcessMath", "Processing math: %1%%", 100], 0),
        ...
        saveScript: function(t, e, i, n) {
            if (!this.outputJax[t.mimeType]) throw i.MathJax.state = n.UPDATE,
            Error("No output jax registered for " + t.mimeType);
            t.outputJax = this.outputJax[t.mimeType][0].id,
            e.jax[t.outputJax] || (0 === e.jaxIDs.length ? e.jax[t.outputJax] = e.scripts: (1 === e.jaxIDs.length && (e.jax[e.jaxIDs[0]] = e.scripts.slice(0, e.i)), e.jax[t.outputJax] = []), e.jaxIDs.push(t.outputJax)),
        ...
        prepareOutput: function(t, e) {
            for (; t.j < t.jaxIDs.length;) {
                ...
                if (n[e]) try {
                    ...
                    return s.restart || (MathJax.Message.Set(["PrepError", "Error preparing %1 output (%2)", i, e], null, 600), MathJax.Hub.lastPrepError = s, t.j++),
                    MathJax.Callback.After(["prepareOutput", this, t, e], s.restart)
                }
                t.j++
            }
            return null
        ...
        processOutput: function(t) {
            var e, i, n = MathJax.ElementJax.STATE,
            a = t.scripts.length;
            try {
                for (; t.i < a;) if (i = t.scripts[t.i], i && i.parentNode && i.MathJax && !i.MathJax.error) {
                    var s = i.MathJax.elementJax;
                    if (s) {
                        e = MathJax.OutputJax[s.outputJax].Process(i, t),
                        e !== !1 && (i.MathJax.state = n.PROCESSED, i.MathJax.preview && (i.MathJax.preview.innerHTML = "", i.MathJax.preview.style.display = "none"), this.signal.Post(["New Math", s.inputID])),
                        t.i++;
                        var r = (new Date).getTime();
                        r - t.start > this.processUpdateTime && t.i < t.scripts.length && (t.start = r, this.RestartAfter(MathJax.Callback.Delay(this.processUpdateDelay)))
                    } else t.i++
                } else t.i++
            } catch(o) {
                return this.processError(o, t, "Output")
            }
            return t.scripts.length && this.config.showProcessingMessages && (MathJax.Message.Set(["TypesetMath", "Typesetting math: %1%%", 100], 0), MathJax.Message.Clear(0)),
            t.i = t.j = 0,
            null
        },
        ...
        processError: function(t, e, i) {
            if (!t.restart) {
                ...
                this.formatError(e.scripts[e.i], t),
                e.i++
            }
            return this.processMessage(e, i),
        ...
        formatError: function(t, e) {
            ...
            (e.line || e.lineNumber) && (n += "\n" + i("ErrorLine", "line: %1", e.line || e.lineNumber)),
            n += "\n\n" + i("ErrorTips", "Debugging tips: use %1, inspect %2 in the browser console", "'unpacked/MathJax.js'", "'MathJax.Hub.lastError'"),
            t.MathJax.error = MathJax.OutputJax.Error.Jax(n, t),
            t.MathJax.elementJax && (t.MathJax.error.inputID = t.MathJax.elementJax.inputID);
            var a = this.config.errorSettings,
            s = i(a.messageId, a.message),
            r = MathJax.HTML.Element("span", {
            ...
            [["span", null, s]]);
            MathJax.Ajax.Require("[MathJax]/spdcalc/extensions/MathEvents.js",
            function() {
            ...
            t.MathJax.preview && (t.MathJax.preview.innerHTML = "", t.MathJax.preview.style.display = "none"),
            this.lastError = e,
            this.signal.Post(["Math Processing Error", t, e])
        },
        RestartAfter: function(t) {
            throw this.Insert(Error("restart"), {
                restart: MathJax.Callback(t)
            })
        },
        elementCallback: function(t, e) {
            ...
            t = [].concat(t);
            for (var n = 0,
            a = t.length; n < a; n++)"string" == typeof t[n] && (t[n] = document.getElementById(t[n]));
        ...
        elementScripts: function(t) {
            ...
            if (MathJax.Object.isArray(t) || this.isHTMLCollection(t)) {
                ...
                n = t.length; i < n; i++) {
                    for (var a = 0,
                    s = 0; s < i && !a; s++) a = t[s].contains(t[i]);
            ...
            null != t.tagName && "script" === t.tagName.toLowerCase() ? [t] : (e = t.getElementsByTagName("script"), this.msieHTMLCollectionBug && (e = this.HTMLCollection2Array(e)), e)
        },
    ...
    MathJax.Hub.Configured = MathJax.Callback({}), MathJax.Hub.Startup = {
        script: "",
        queue: MathJax.Callback.Queue(),
        signal: MathJax.Callback.Signal("Startup"),
        params: {},
        Config: function() {
            if (this.queue.Push(["Post", this.signal, "Begin Config"]), MathJax.AuthorConfig && MathJax.AuthorConfig.root && (MathJax.Ajax.config.root = MathJax.AuthorConfig.root), this.params.locale && (MathJax.Localization.resetLocale(this.params.locale), MathJax.Hub.config.menuSettings.locale = this.params.locale), this.params.config) for (var t = this.params.config.split(/,/), e = 0, i = t.length; e < i; e++) t[e].match(/\.js$/) || (t[e] += ".js"),
            this.queue.Push(["Require", MathJax.Ajax, this.URL("config", t[e])]);
            this.queue.Push(["Config", MathJax.Hub, MathJax.AuthorConfig]),
            this.script.match(/\S/) && this.queue.Push(this.script + ";\n1;"),
            this.queue.Push(["ConfigDelay", this], ["ConfigBlocks", this], [function(t) {
        ...
        Cookie: function() {
            return this.queue.Push(["Post", this.signal, "Begin Cookie"], ["Get", MathJax.HTML.Cookie, "menu", MathJax.Hub.config.menuSettings], [function(t) {
                ...
                if (i) {
                    ...
                    n.sort();
                    for (var s = 0,
                    r = n.length; s < r && "output/" !== n[s].substr(0, 7); s++);
                    if (s == r - 1) n.pop();
                    else for (; s < r;) {
                        if (n[s] === a) {
                            n.splice(s, 1);
                ...
                null != e.CHTMLpreview && (null == e.FastPreview && (e.FastPreview = e.CHTMLpreview), delete e.CHTMLpreview),
                e.FastPreview && !MathJax.Extension["fast-preview"] && MathJax.Hub.config.extensions.push("fast-preview.js"),
                t.menuSettings.assistiveMML && !MathJax.Extension.AssistiveMML && MathJax.Hub.config.extensions.push("AssistiveMML.js")
            },
        ...
        Jax: function() {
            ...
            var r = MathJax.Callback.Queue();
            return r.Push(["Post", this.signal, "Begin Jax"], ["loadArray", this, t.jax, "jax", "config.js"], ["Post", this.signal, "End Jax"])
        },
        Extensions: function() {
            var t = MathJax.Callback.Queue();
            return t.Push(["Post", this.signal, "Begin Extensions"], ["loadArray", this, MathJax.Hub.config.extensions, "extensions"], ["Post", this.signal, "End Extensions"])
        },
        Message: function() {
            MathJax.Message.Init(!0)
        },
        Menu: function() {
            var t, e = MathJax.Hub.config.menuSettings,
        ...
        Hash: function() {
            if (MathJax.Hub.config.positionToHash && document.location.hash && document.body && document.body.scrollIntoView) {
                ...
                if (e) {
                    ...
                    e = this.HashCheck(e),
                    e && e.scrollIntoView && setTimeout(function() {
                        e.scrollIntoView(!0)
                    },
                    1)
                }
        ...
        HashCheck: function(t) {
            ...
            return e && MathJax.OutputJax[e.outputJax].hashCheck && (t = MathJax.OutputJax[e.outputJax].hashCheck(t)),
            t
        },
        MenuZoom: function() {
            MathJax.Hub.config.showMathMenu && (MathJax.Extension.MathMenu ? setTimeout(MathJax.Callback(["loadDomain", MathJax.Localization, "MathMenu"]), 1e3) : setTimeout(function() {
                MathJax.Callback.Queue(["Require", MathJax.Ajax, "[MathJax]/spdcalc/extensions/MathMenu.js", {}], ["loadDomain", MathJax.Localization, "MathMenu"])
            },
            1e3), MathJax.Extension.MathZoom || setTimeout(MathJax.Callback(["Require", MathJax.Ajax, "[MathJax]/spdcalc/extensions/MathZoom.js", {}]), 2e3))
        },
        onLoad: function() {
            ...
            return window.addEventListener ? (window.addEventListener("load", t, !1), this.params.noDOMContentEvent || window.addEventListener("DOMContentLoaded", t, !1)) : window.attachEvent ? window.attachEvent("onload", t) : window.onload = t,
            t
        },
        Typeset: function(t, e) {
            return MathJax.Hub.config.skipStartupTypeset ?
            function() {}: this.queue.Push(["Post", this.signal, "Begin Typeset"], ["Typeset", MathJax.Hub, t, e], ["Post", this.signal, "End Typeset"])
        },
        URL: function(t, e) {
            return e.match(/^([a-z]+:\/\/|\[|\/)/) || (e = "[MathJax]/spdcalc/" + t + "/" + e),
            e
        },
        loadArray: function(t, e, i, n) {
            if (t && (MathJax.Object.isArray(t) || (t = [t]), t.length)) {
                for (var a, s = MathJax.Callback.Queue(), r = {},
                o = 0, l = t.length; o < l; o++) a = this.URL(e, t[o]),
                i && (a += "/" + i),
                n ? s.Push(["Require", MathJax.Ajax, a, r]) : s.Push(MathJax.Ajax.Require(a, r));
                return s.Push({})
            }
            return null
        }
    ...
    function(t) {
        ...
        r = MathJax.Object.Subclass({
            ...
            loadComplete: function(t) {
                ...
                this.config || {},
                this.id], ["Post", n.Startup.signal, this.id + " Jax Startup"], ["Startup", this], ["Post", n.Startup.signal, this.id + " Jax Ready"]),
                this.copyTranslate && e.Push([function(t) {
        ...
        e.InputJax = r.Subclass({
            ...
            Process: function(t, i) {
                var r, o = s.Queue(),
                l = this.elementJax;
                e.Object.isArray(l) || (l = [l]);
                for (var h = 0,
                u = l.length; h < u; h++) r = e.ElementJax.directory + "/" + l[h] + "/" + this.JAXFILE,
                this.require ? e.Object.isArray(this.require) || (this.require = [this.require]) : this.require = [],
                this.require.push(r),
                o.Push(a.Require(r));
                ...
                l = n.outputJax["jax/" + l[0]],
                l && o.Push(a.Require(l[0].directory + "/" + this.JAXFILE)),
                o.Push({})
            },
        ...
        e.OutputJax = r.Subclass({
            ...
            Register: function(t) {
                var i = n.outputJax;
                i[t] || (i[t] = []),
                i[t].length && (this.id === n.config.menuSettings.renderer || (i.order[this.id] || 0) < (i.order[i[t][0].id] || 0)) ? i[t].unshift(this) : i[t].push(this),
                this.require ? e.Object.isArray(this.require) || (this.require = [this.require]) : this.require = [],
                this.require.push(e.ElementJax.directory + "/" + t.split(/\//)[1] + "/" + this.JAXFILE)
            },
            Remove: function(t) {}
        },
        {
        ...
        e.ElementJax = r.Subclass({
            ...
            Text: function(t, i) {
                ...
                return e.HTML.setScript(a, t),
                a.MathJax.state = this.STATE.UPDATE,
                n.Update(a, i)
            },
            Reprocess: function(t) {
                var e = this.SourceElement();
                return e.MathJax.state = this.STATE.UPDATE,
                n.Reprocess(e, t)
            },
            Update: function(t) {
            ...
            Rerender: function(t) {
                var e = this.SourceElement();
                return e.MathJax.state = this.STATE.OUTPUT,
                n.Process(e, t)
            },
            Remove: function(t) {
                this.hover && this.hover.clear(this),
                e.OutputJax[this.outputJax].Remove(this),
                t || (n.signal.Post(["Remove Math", this.inputID]), this.Detach())
            },
            ...
            Attach: function(t, i) {
                ...
                return t.MathJax.state === this.STATE.UPDATE ? n.Clone(this) : (n = t.MathJax.elementJax = this, t.id ? this.inputID = t.id: (t.id = this.inputID = e.ElementJax.GetID(), this.newID = 1)),
            ...
            Clone: function(t) {
                var e;
                for (e in this) this.hasOwnProperty(e) && "undefined" == typeof t[e] && "newID" !== e && delete this[e];
                for (e in t) t.hasOwnProperty(e) && ("undefined" == typeof this[e] || this[e] !== t[e] && "inputID" !== e) && (this[e] = t[e])
            }
        },
        {
            id: "ElementJax",
            ...
            Subclass: function() {
                ...
                return t.loadComplete = this.prototype.loadComplete,
                t
            }
        }),
    ...
    function(t) {
        ...
        for (var o = new RegExp("(^|/)" + t + "\\.js(\\?.*)?$"), l = r.length - 1; l >= 0; l--) if ((r[l].src || "").match(o)) {
            if (n.script = r[l].innerHTML, RegExp.$2) for (var h = RegExp.$2.substr(1).split(/\&/), u = 0, c = h.length; u < c; u++) {
                var p = h[u].match(/(.*)=(.*)/);
                p ? n.params[unescape(p[1])] = unescape(p[2]) : n.params[h[u]] = !0
            }
            a.root = r[l].src.replace(/(^|\/)[^\/]*(\?.*)?$/, "").replace(/^(https?:\/\/cdn.mathjax.org\/mathjax\/)(latest)/, "$1" + e.version.split(/\./).slice(0, 2).join(".") + "-$2"),
        ...
        f = {
            ...
            versionAtLeast: function(t) {
                ...
                t = new String(t).split(".");
                for (var i = 0,
                n = t.length; i < n; i++) if (e[i] != t[i]) return parseInt(e[i] || "0") >= parseInt(t[i]);
                return ! 0
            },
            Select: function(t) {
                var e = t[i.Browser];
        ...
        i.Browser = i.Insert(i.Insert(new String("Unknown"), {
            version: "0.0"
        }), f);
        for (var x in f) if (f.hasOwnProperty(x) && f[x] && "is" === x.substr(0, 2)) {
            if (x = x.slice(2), "Mac" === x || "PC" === x) continue;
            i.Browser = i.Insert(new String(x), f);
            var m = new RegExp(".*(Version/| Trident/.*; rv:)((?:\\d+\\.)+\\d+)|.*(" + x + ")" + ("MSIE" == x ? " ": "/") + "((?:\\d+\\.)*\\d+)|(?:^|\\(| )([a-z][-a-z0-9._: ]+|(?:Apple)?WebKit)/((?:\\d+\\.)+\\d+)"),
            M = m.exec(g) || ["", "", "", "unknown", "0.0"];
        ...
        try {
            i.Browser.Select({
                Safari: function(t) {
                    ...
                    e >= 538 ? t.version = "8.0": e >= 537 ? t.version = "7.0": e >= 536 ? t.version = "6.0": e >= 534 ? t.version = "5.1": e >= 533 ? t.version = "5.0": e >= 526 ? t.version = "4.0": e >= 525 ? t.version = "3.1": e > 500 ? t.version = "3.0": e > 400 ? t.version = "2.0": e > 85 && (t.version = "1.0"),
                    ...
                    if (t.isMobile = !!navigator.userAgent.match(/ Phone/), t.isIE9 = !(!document.documentMode || !window.performance && !window.msPerformance), MathJax.HTML.setScriptBug = !t.isIE9 || document.documentMode < 9, MathJax.Hub.msieHTMLCollectionBug = document.documentMode < 9, document.documentMode < 10 && !n.params.NoMathPlayer) {
                        ...
                        try {
                            if (t.hasMathPlayer) {
                                ...
                                t.mpNamespace = !0,
                                !document.readyState || "loading" !== document.readyState && "interactive" !== document.readyState || (document.write('<?import namespace="m" implementation="#MathPlayer">'), t.mpImported = !0)
        ...
        e.AuthorConfig && "function" == typeof e.AuthorConfig.AuthorInit && e.AuthorConfig.AuthorInit(),
        i.queue = e.Callback.Queue(),
        i.queue.Push(["Post", n.signal, "Begin"], ["Config", n], ["Cookie", n], ["Styles", n], ["Message", n],
        function() {
            var t = e.Callback.Queue(n.Jax(), n.Extensions());
            return t.Push({})
        },
        ["Menu", n], n.onLoad(),
        function() {
